...
class DoctorPageLocators:
    CLUB_TAB_BUTTON = (
        By.CSS_SELECTOR, '[data-doctor-id="888804"] .appointment-type-tab__item:nth-child(1)')
    DEFAULT_TAB_BUTTON = (
        By.CSS_SELECTOR, '[data-doctor-id="888804"] .appointment-type-tab__item:nth-child(2)')
